...
# - fits each of the alternative methods (method 0 - 6) 
...
# Berger et. al (2019) and the functions implemented in "function.R".
...
# The results of the second part of the simulation study ('Comparison to alternative methods') for the six methods 
# GB logL, GBg, PL, PLg, Tree, Null and True are stored in "./raw_results/simulation.rda" (as a list with 2100 elements). 
# The results of the method GB StabS with pi=0.7 are stored in "./raw_results/simulationGBStabs.rda".

# The function one_sim() was called 2,100 times with values n=250, k=10, b=0.9 and the following other arguments: 
...
# library("batchtools")
# 
# r <- makeRegistry(file.dir="./Simulation/simulation")
# # r <- loadRegistry(file.dir="./Simulation/simulation")
# 
# args <- expand.grid(seed=c(1:100)+160920, 
#                     n=250,
#                     k=10,
