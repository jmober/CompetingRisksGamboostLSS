...
# The R-Code provided can be used to reproduce Figure S3, Figure S4 and 
...
mean_S4 <- aggregate(values~noninf+method, mean, data=for_table)
mean_S4[,3]*100
sd_S4 <- aggregate(values~noninf+method, sd, data=for_table)
sd_S4[,3]*100
