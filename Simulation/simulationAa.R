...
# Berger et. al (2019) and the functions implemented in "functionAa.R".
...
one_sim <- function(seed, n, k, b, noninf, mmax, method){
  ...
  source("./Simulation/functionAa.R")
...
# The results of additional simulation scenario (a) for the seven methods 
# GB logL, GB StabS, GBg, PL, PLg, Tree, Null and True are stored in 
# "./raw_results/simulationAa.rda" (as a list with 2400 elements). 

# The function one_sim() was called 2,400 times with values n=250, k=10, b=1.8 and the following other arguments: 
...
one_sim(seed=160921, n=250, k=10, b=1.8, noninf=10, mmax=15000, method=0)
...
one_sim(seed=160922, n=250, k=10, b=1.8, noninf=10, mmax=15000, method=3)

# result is stored in 
res[[902]]

## Example 3: seed=160924, noninf=200, mmax=120, method=1 (GB logL)
one_sim(seed=160924, n=250, k=10, b=1.8, noninf=200, mmax=120, method=1)
...
# library("batchtools")
# 
# r <- makeRegistry(file.dir="./Simulation/simulationAa")
# # r <- loadRegistry(file.dir="./Simulation/simulationAa")
# 
# args <- expand.grid(seed=c(1:100)+160920, 
#                     n=250,
#                     k=10,
